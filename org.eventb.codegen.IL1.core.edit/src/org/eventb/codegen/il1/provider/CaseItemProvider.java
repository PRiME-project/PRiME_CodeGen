...
/**
 * This is the item provider adapter for a {@link org.eventb.codegen.il1.Case} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CaseItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Case_caseExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Case_caseExpression_feature", "_UI_Case_type"),
				 Il1Package.Literals.CASE__CASE_EXPRESSION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Il1Package.Literals.CASE__CASE_STATEMENT);
		}
	...
	public String getText(Object object) {
		String label = ((Case)object).getParentEventName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Il1Package.Literals.CASE__CASE_STATEMENT,
				 Il1Factory.eINSTANCE.createCaseStatement()));
	}
