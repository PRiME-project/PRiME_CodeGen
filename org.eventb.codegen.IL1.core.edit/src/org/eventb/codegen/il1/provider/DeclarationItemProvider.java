...
/**
 * This is the item provider adapter for a {@link org.eventb.codegen.il1.Declaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeclarationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Declaration_identifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Declaration_identifier_feature", "_UI_Declaration_type"),
				 Il1Package.Literals.DECLARATION__IDENTIFIER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Il1Package.Literals.DECLARATION__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addInitialValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Declaration_initialValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Declaration_initialValue_feature", "_UI_Declaration_type"),
				 Il1Package.Literals.DECLARATION__INITIAL_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addProjectNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Declaration_ProjectName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Declaration_ProjectName_feature", "_UI_Declaration_type"),
				 Il1Package.Literals.DECLARATION__PROJECT_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addComponentNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Declaration_ComponentName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Declaration_ComponentName_feature", "_UI_Declaration_type"),
				 Il1Package.Literals.DECLARATION__COMPONENT_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Declaration)object).getProjectName();
