...
/**
 * This is the item provider adapter for a {@link org.eventb.codegen.il1.Call} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CallItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Call_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Call_target_feature", "_UI_Call_type"),
				 Il1Package.Literals.CALL__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSubroutinePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Call_subroutine_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Call_subroutine_feature", "_UI_Call_type"),
				 Il1Package.Literals.CALL__SUBROUTINE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addMachineNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Call_machineName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Call_machineName_feature", "_UI_Call_type"),
				 Il1Package.Literals.CALL__MACHINE_NAME,
				 true,
				 false,
				 false,
	...
	protected void addProjectNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Call_projectName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Call_projectName_feature", "_UI_Call_type"),
				 Il1Package.Literals.CALL__PROJECT_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Il1Package.Literals.CALL__ACTUAL_PARAMETERS);
		}
	...
	public String getText(Object object) {
		String label = ((Call)object).getParentEventName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Il1Package.Literals.CALL__ACTUAL_PARAMETERS,
