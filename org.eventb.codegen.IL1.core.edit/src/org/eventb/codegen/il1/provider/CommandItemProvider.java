...
/**
 * This is the item provider adapter for a {@link org.eventb.codegen.il1.Command} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommandItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addParentEventNamePropertyDescriptor(object);
	...
	protected void addEnvirStateMachineChildPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Command_envirStateMachineChild_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Command_envirStateMachineChild_feature", "_UI_Command_type"),
				 Il1Package.Literals.COMMAND__ENVIR_STATE_MACHINE_CHILD,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Command)object).getParentEventName();
