 ...
 * $Id$
 */
package org.eventb.codegen.il1.RequiredMetadata.util;
 ...
 * @generated
 */
public class RequiredMetadataSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static RequiredMetadataPackage modelPackage;
	 ...
	 * @generated
	 */
	public RequiredMetadataSwitch() {
		if (modelPackage == null) {
			modelPackage = RequiredMetadataPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RequiredMetadataPackage.SUBROUTINE_META_DATA: {
				SubroutineMetaData subroutineMetaData = (SubroutineMetaData)theEObject;
				T result = caseSubroutineMetaData(subroutineMetaData);
