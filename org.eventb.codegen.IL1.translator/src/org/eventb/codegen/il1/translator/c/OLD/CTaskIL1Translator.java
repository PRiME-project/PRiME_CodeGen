...
@Deprecated
public class CTaskIL1Translator extends AbstractIL1Translator {
	...
	public ArrayList<String> translate(IL1Element source,
		...
		String functionDecl = "void " + actualSource.getName().replaceAll(" ", "") + "()";
		outCode.add(functionDecl);
		outCode.add("{");
		
		headerInfo.getHeaderEntries().add(functionDecl + ";"); 
