...
/**
 * This is the item provider adapter for a {@link ac.soton.compositionmodel.core.compositionmodel.IncludedMachine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IncludedMachineItemProvider
	...
	protected void addMachineNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IncludedMachine_machineName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IncludedMachine_machineName_feature", "_UI_IncludedMachine_type"),
				 CompositionmodelPackage.eINSTANCE.getIncludedMachine_MachineName(),
				 true,
				 false,
				 false,
	...
	protected void addProjectNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IncludedMachine_projectName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IncludedMachine_projectName_feature", "_UI_IncludedMachine_type"),
				 CompositionmodelPackage.eINSTANCE.getIncludedMachine_ProjectName(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((IncludedMachine)object).getMachineName();
