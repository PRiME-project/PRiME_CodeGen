...
public class BranchItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Branch_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Branch_label_feature", "_UI_Branch_type"),
				 CompositeControlPackage.Literals.BRANCH__LABEL,
				 true,
				 false,
				 false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CompositeControlPackage.Literals.BRANCH__SUB_BRANCH,
