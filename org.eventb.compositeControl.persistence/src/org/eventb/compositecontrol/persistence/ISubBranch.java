...
public interface ISubBranch extends ICompositeControlCommon {
	
	public static IInternalElementType<ISeq> ELEMENT_TYPE = RodinCore.getInternalElementType(CompositeControlPersistencePlugin.PLUGIN_ID + ".subbranch");
	public static IAttributeType.String SUBBRANCH_ATTRIBUTE = RodinCore.getStringAttrType(CompositeControlPersistencePlugin.PLUGIN_ID + ".compositecontrol");
