...
public interface ISeq extends ICompositeControlCommon {
	
	public static IInternalElementType<ISeq> ELEMENT_TYPE = RodinCore.getInternalElementType(CompositeControlPersistencePlugin.PLUGIN_ID + ".seq");
	public static IAttributeType.String SEQ_ATTRIBUTE = RodinCore.getStringAttrType(CompositeControlPersistencePlugin.PLUGIN_ID + ".compositecontrol");
