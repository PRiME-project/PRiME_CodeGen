...
public interface IBranch extends ICompositeControlCommon {
	public static IInternalElementType<IBranch> ELEMENT_TYPE = RodinCore.getInternalElementType(CompositeControlPersistencePlugin.PLUGIN_ID + ".branch");
	public static IAttributeType.String BRANCH_ATTRIBUTE = RodinCore.getStringAttrType(CompositeControlPersistencePlugin.PLUGIN_ID + ".compositecontrol");
