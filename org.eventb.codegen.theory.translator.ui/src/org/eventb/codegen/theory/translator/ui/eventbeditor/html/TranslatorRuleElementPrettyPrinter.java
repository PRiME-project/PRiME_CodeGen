 ...
 *
 */
public class TranslatorRuleElementPrettyPrinter extends DefaultPrettyPrinter
	...
	private static final String TRANSLATOR_FORMULA = "componentName";
	private static final String TRANSLATOR_FORMULA_SEPARATOR_BEGIN = null;
	private static final String TRANSLATOR_FORMULA_SEPARATOR_END = null;
	...
	public void prettyPrint(IInternalElement elt, IInternalElement parent,	IPrettyPrintStream ps) {
		if (elt instanceof ITranslatorRuleElement) {
			ITranslatorRuleElement translation = (ITranslatorRuleElement)elt;
			try {
				...
				if(translation.hasFormula() && !translation.getFormula().equals(""))
					appendFormula(ps,wrapString(translation.getFormula()));
	...
	private static void appendFormula(IPrettyPrintStream ps, String formula) {
		ps.appendString(formula, //
				getHTMLBeginForCSSClass(TRANSLATOR_FORMULA, //
						HorizontalAlignment.LEFT, //
						VerticalAlignement.MIDDLE),//
						getHTMLEndForCSSClass(TRANSLATOR_FORMULA, //
								HorizontalAlignment.LEFT, //
								VerticalAlignement.MIDDLE),//
								TRANSLATOR_FORMULA_SEPARATOR_BEGIN, //
								TRANSLATOR_FORMULA_SEPARATOR_END);
	}
