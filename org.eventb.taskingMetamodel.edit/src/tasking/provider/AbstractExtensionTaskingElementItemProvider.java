...
/**
 * This is the item provider adapter for a {@link tasking.AbstractExtensionTaskingElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractExtensionTaskingElementItemProvider
	 ...
	 * @generated
	 */
	public AbstractExtensionTaskingElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractExtensionTaskingElement)object).getReference();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractExtensionTaskingElement_type") :
			getString("_UI_AbstractExtensionTaskingElement_type") + " " + label;
	}
