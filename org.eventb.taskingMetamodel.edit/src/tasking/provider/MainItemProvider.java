...
/**
 * This is the item provider adapter for a {@link tasking.Main} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MainItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Main_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Main_name_feature", "_UI_Main_type"),
				 TaskingPackage.Literals.MAIN__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TaskingPackage.Literals.MAIN__MAIN_BODY);
			childrenFeatures.add(TaskingPackage.Literals.MAIN__MACHINES);
			childrenFeatures.add(TaskingPackage.Literals.MAIN__CONTEXTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TaskingPackage.Literals.MAIN__MAIN_BODY,
		...
		newChildDescriptors.add
			(createChildParameter
				(TaskingPackage.Literals.MAIN__MACHINES,
				 MachineFactory.eINSTANCE.createMachine()));

		newChildDescriptors.add
			(createChildParameter
				(TaskingPackage.Literals.MAIN__CONTEXTS,
