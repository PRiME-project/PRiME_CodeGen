...
/**
 * This is the item provider adapter for a {@link tasking.EventBElementTaskingElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventBElementTaskingElementItemProvider
	 ...
	 * @generated
	 */
	public EventBElementTaskingElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((EventBElementTaskingElement)object).getReference();
		return label == null || label.length() == 0 ?
			getString("_UI_EventBElementTaskingElement_type") :
			getString("_UI_EventBElementTaskingElement_type") + " " + label;
	}
