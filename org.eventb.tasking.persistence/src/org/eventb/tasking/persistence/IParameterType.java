...
public interface IParameterType extends IInternalElement {
	
	public static IInternalElementType<IImplementation> ELEMENT_TYPE = RodinCore.getInternalElementType(TaskingPersistencePlugin.PLUGIN_ID + ".parametertype");
	public static IAttributeType.String PARAMETERTYPE_ATTRIBUTE = RodinCore.getStringAttrType(TaskingPersistencePlugin.PLUGIN_ID + ".tasking");
	...
	ParameterTypeEnum getParameterType() throws RodinDBException;
	
	void setParameterType(ParameterTypeEnum type) throws RodinDBException;
