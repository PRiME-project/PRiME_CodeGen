...
public interface IShared_Machine extends IMachineType {
	
	public static IInternalElementType<IShared_Machine> ELEMENT_TYPE = RodinCore.getInternalElementType(TaskingPersistencePlugin.PLUGIN_ID + ".sharedMachine");
	
	//	probably not needed
	public static IAttributeType.String SHARED_MACHINE_ATTRIBUTE = RodinCore.getStringAttrType(TaskingPersistencePlugin.PLUGIN_ID + ".tasking");
