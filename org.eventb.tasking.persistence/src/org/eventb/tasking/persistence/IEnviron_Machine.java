...
public interface IEnviron_Machine extends IInternalElement, ITask {
	
	public static IInternalElementType<IEnviron_Machine> ELEMENT_TYPE = RodinCore.getInternalElementType(TaskingPersistencePlugin.PLUGIN_ID + ".environMachine");
	public static IAttributeType.String ENVIRON_MACHINE_ATTRIBUTE = RodinCore.getStringAttrType(TaskingPersistencePlugin.PLUGIN_ID + ".tasking");
