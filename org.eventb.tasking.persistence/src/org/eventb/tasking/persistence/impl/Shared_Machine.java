...
public class Shared_Machine extends MachineType implements IShared_Machine {
	
	
	public Shared_Machine(String name, IRodinElement parent) {
		super(name, parent);
	}
...
//	}
	...
	public boolean hasSerialisedString() throws RodinDBException {
		return hasAttribute(SHARED_MACHINE_ATTRIBUTE);
	} 
	...
	public String getSerialisedString() throws RodinDBException {
		return getAttributeValue(SHARED_MACHINE_ATTRIBUTE);
	}
	...
	public void setSerialisedString(String string, IProgressMonitor monitor)
		...
		setAttributeValue(SHARED_MACHINE_ATTRIBUTE, string, monitor);
	}
}
